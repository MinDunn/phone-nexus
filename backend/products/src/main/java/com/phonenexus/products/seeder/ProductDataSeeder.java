...
public class ProductDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Brands
        Brand apple = Brand.builder().name("Apple").description("Think Different").logoUrl("logo_apple.png").build();
        Brand samsung = Brand.builder().name("Samsung").description("Imagine").logoUrl("logo_samsung.png").build();
        Brand xiaomi = Brand.builder().name("Xiaomi").description("Innovation for everyone").logoUrl("logo_xiaomi.png")
                .build();
        ...
        Product galaxyS24 = Product.builder().name("Samsung Galaxy S24 Ultra").description("Galaxy AI").brand(samsung)
                .category(phone).build();
